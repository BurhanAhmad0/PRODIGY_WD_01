    ...
    return (
        <section className='px-4 md:px-8 mb-20'>
            ...
            <div className="main-content w-full md:max-w-4xl text-white mx-auto flex flex-col lg:flex-row items-center justify-between gap-8 mb-9">
                <div className="image-catalog relative w-full lg:w-1/2 flex items-end justify-center gap-4 overflow-hidden">
                    <img className="" src="/img/about-img-1.svg" alt="about-img-1" />
                    <img className="" src="/img/about-img-2.svg" alt="about-img-2" />
                    <img className='absolute right-5 top-8 w-16 md:w-28' src="/img/globe.svg" alt="globe" />
                </div>
